...
function onResults(results) {
  ...
  canvasCtx.fillText("Enteer Your Salary = " + Salary, 10, 150);
  canvasCtx.fillText("Press the button:", 10, 360);
  canvasCtx.fillText("Submit ", 200, 400);
  canvasCtx.fillText("1 0-2000", 75, 200);
  canvasCtx.fillText("2 2001-4000", 225, 200);
  ...
  if (cx > 200 && cx < 300 && cy > 100 && cy<100 && counter==1)
  {
    age = age - 1;
    if (age<0){
      age = 0
  ...
  if (cx > 210 && cx < 340 && cy > 170 && cy<220 && counter==1)
  {
    Salary = 2;
